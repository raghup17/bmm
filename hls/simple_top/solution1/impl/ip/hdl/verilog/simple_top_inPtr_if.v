...
//------------------------Instantiation------------------
// simple_top_inPtr_request_preprocessor
simple_top_inPtr_request_preprocessor #(
...
module simple_top_inPtr_request_preprocessor/*{{{*/
#(parameter
    C_USER_DATA_WIDTH = 8
)(
    // system signal
...
if (USER_DATA_BYTES <= BUS_DATA_BYTES) begin : gen_write_ready_0
    assign write_ready = (state==IDLE) | ((state==DATA) & ~enough_data &
                         (~data_valid[DATA_BUF_BYTES-1] | WREADY));
end
...
//------------------------Instantiation------------------
// simple_top_inPtr_read_data_align
simple_top_inPtr_read_data_align #(
    .C_DATA_WIDTH      ( C_DATA_WIDTH ),
    .C_USER_DATA_WIDTH ( C_USER_DATA_WIDTH )
) data_align (
...
module simple_top_inPtr_read_data_align/*{{{*/
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
...
module simple_top_inPtr_reg_slice/*{{{*/
#(parameter
    N = 8   // data width
) (
    // system signals
