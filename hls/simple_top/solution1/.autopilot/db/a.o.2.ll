...
define void @simple_top(i32* %inPtr) nounwind uwtable {
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %inPtr) nounwind, !map !906
  call void (...)* @_ssdm_op_SpecTopModule([11 x i8]* @str) nounwind
  %i = alloca i32, align 4                        ; [#uses=6 type=i32*]
  call void @llvm.dbg.value(metadata !{i32* %inPtr}, i64 0, metadata !910), !dbg !911 ; [debug line = 5:31] [debug variable = inPtr]
  call void (...)* @_ssdm_op_SpecBus(i32* %inPtr, [7 x i8]* @.str, i32 0, i32 0, i32 0, [1 x i8]* @.str1) nounwind, !dbg !912 ; [debug line = 7:1]
  call void (...)* @_ssdm_op_SpecIFCore(i32* %inPtr, [1 x i8]* @.str1, [6 x i8]* @.str2, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !914 ; [debug line = 8:1]
  store volatile i32 0, i32* %i, align 4, !dbg !915 ; [debug line = 20:7]
  br label %1, !dbg !915                          ; [debug line = 20:7]

; <label>:1                                       ; preds = %2, %0
  call void @llvm.dbg.value(metadata !{i32* %i}, i64 0, metadata !917), !dbg !915 ; [debug line = 20:7] [debug variable = i]
  %i.load = load volatile i32* %i, align 4, !dbg !915 ; [#uses=1 type=i32] [debug line = 20:7]
  %tmp = icmp slt i32 %i.load, 32, !dbg !915      ; [#uses=1 type=i1] [debug line = 20:7]
  br i1 %tmp, label %2, label %3, !dbg !915       ; [debug line = 20:7]

; <label>:2                                       ; preds = %1
  call void @llvm.dbg.value(metadata !{i32* %i}, i64 0, metadata !917), !dbg !918 ; [debug line = 21:3] [debug variable = i]
  %i.load.1 = load volatile i32* %i, align 4, !dbg !918 ; [#uses=1 type=i32] [debug line = 21:3]
  %tmp.1 = sext i32 %i.load.1 to i64, !dbg !918   ; [#uses=1 type=i64] [debug line = 21:3]
  %inPtr.addr = getelementptr inbounds i32* %inPtr, i64 %tmp.1, !dbg !918 ; [#uses=1 type=i32*] [debug line = 21:3]
  %inPtr.load = load volatile i32* %inPtr.addr, align 4, !dbg !918 ; [#uses=1 type=i32] [debug line = 21:3]
  %tmp.2 = add nsw i32 %inPtr.load, 10, !dbg !918 ; [#uses=1 type=i32] [debug line = 21:3]
  call void @llvm.dbg.value(metadata !{i32* %i}, i64 0, metadata !917), !dbg !918 ; [debug line = 21:3] [debug variable = i]
  %i.load.2 = load volatile i32* %i, align 4, !dbg !918 ; [#uses=1 type=i32] [debug line = 21:3]
  %tmp.3 = sext i32 %i.load.2 to i64, !dbg !918   ; [#uses=1 type=i64] [debug line = 21:3]
  %inPtr.addr.1 = getelementptr inbounds i32* %inPtr, i64 %tmp.3, !dbg !918 ; [#uses=1 type=i32*] [debug line = 21:3]
  store volatile i32 %tmp.2, i32* %inPtr.addr.1, align 4, !dbg !918 ; [debug line = 21:3]
  call void @llvm.dbg.value(metadata !{i32* %i}, i64 0, metadata !917), !dbg !920 ; [debug line = 20:18] [debug variable = i]
  %i.load.3 = load volatile i32* %i, align 4, !dbg !920 ; [#uses=1 type=i32] [debug line = 20:18]
  %i.1 = add nsw i32 %i.load.3, 1, !dbg !920      ; [#uses=1 type=i32] [debug line = 20:18]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !917), !dbg !920 ; [debug line = 20:18] [debug variable = i]
  store volatile i32 %i.1, i32* %i, align 4, !dbg !920 ; [debug line = 20:18]
  br label %1, !dbg !920                          ; [debug line = 20:18]

; <label>:3                                       ; preds = %1
  ret void, !dbg !921                             ; [debug line = 24:1]
}
...
!899 = metadata !{metadata !900, [1 x i32]* @llvm.global_ctors.0}
!900 = metadata !{metadata !901}
!901 = metadata !{i32 0, i32 31, metadata !902}
!902 = metadata !{metadata !903}
!903 = metadata !{metadata !"llvm.global_ctors.0", metadata !904, metadata !""}
!904 = metadata !{metadata !905}
!905 = metadata !{i32 0, i32 0, i32 1}
!906 = metadata !{metadata !907}
!907 = metadata !{i32 0, i32 31, metadata !908}
!908 = metadata !{metadata !909}
!909 = metadata !{metadata !"inPtr", metadata !904, metadata !"int"}
!910 = metadata !{i32 786689, metadata !832, metadata !"inPtr", metadata !833, i32 16777221, metadata !836, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!911 = metadata !{i32 5, i32 31, metadata !832, null}
!912 = metadata !{i32 7, i32 1, metadata !913, null}
!913 = metadata !{i32 786443, metadata !832, i32 6, i32 1, metadata !833, i32 0} ; [ DW_TAG_lexical_block ]
!914 = metadata !{i32 8, i32 1, metadata !913, null}
!915 = metadata !{i32 20, i32 7, metadata !916, null}
!916 = metadata !{i32 786443, metadata !913, i32 20, i32 2, metadata !833, i32 1} ; [ DW_TAG_lexical_block ]
!917 = metadata !{i32 786688, metadata !913, metadata !"i", metadata !833, i32 13, metadata !837, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!918 = metadata !{i32 21, i32 3, metadata !919, null}
!919 = metadata !{i32 786443, metadata !916, i32 20, i32 23, metadata !833, i32 2} ; [ DW_TAG_lexical_block ]
!920 = metadata !{i32 20, i32 18, metadata !916, null}
!921 = metadata !{i32 24, i32 1, metadata !913, null}
