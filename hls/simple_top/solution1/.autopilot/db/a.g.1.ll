; ModuleID = '/home/raghu/work/projects/dma3/hls/simple_top/solution1/.autopilot/db/a.g.1.bc'
...
define void @simple_top(i32* %inPtr) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i32* %inPtr}, i64 0, metadata !899), !dbg !900 ; [debug line = 5:31] [debug variable = inPtr]
  call void (...)* @_ssdm_op_SpecBus(i32* %inPtr, i8* getelementptr inbounds ([7 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !901 ; [debug line = 7:1]
  call void (...)* @_ssdm_op_SpecResource(i32* %inPtr, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !903 ; [debug line = 8:1]
  store volatile i32 0, i32* %i, align 4, !dbg !904 ; [debug line = 20:7]
  br label %1, !dbg !904                          ; [debug line = 20:7]

; <label>:1                                       ; preds = %2, %0
  call void @llvm.dbg.value(metadata !{i32* %i}, i64 0, metadata !906), !dbg !904 ; [debug line = 20:7] [debug variable = i]
  %i.load = load volatile i32* %i, align 4, !dbg !904 ; [#uses=1 type=i32] [debug line = 20:7]
  %tmp = icmp slt i32 %i.load, 32, !dbg !904      ; [#uses=1 type=i1] [debug line = 20:7]
  br i1 %tmp, label %2, label %3, !dbg !904       ; [debug line = 20:7]

; <label>:2                                       ; preds = %1
  call void @llvm.dbg.value(metadata !{i32* %i}, i64 0, metadata !906), !dbg !907 ; [debug line = 21:3] [debug variable = i]
  %i.load.1 = load volatile i32* %i, align 4, !dbg !907 ; [#uses=1 type=i32] [debug line = 21:3]
  %tmp.1 = sext i32 %i.load.1 to i64, !dbg !907   ; [#uses=1 type=i64] [debug line = 21:3]
  %inPtr.addr = getelementptr inbounds i32* %inPtr, i64 %tmp.1, !dbg !907 ; [#uses=1 type=i32*] [debug line = 21:3]
  %inPtr.load = load volatile i32* %inPtr.addr, align 4, !dbg !907 ; [#uses=1 type=i32] [debug line = 21:3]
  %tmp.2 = add nsw i32 %inPtr.load, 10, !dbg !907 ; [#uses=1 type=i32] [debug line = 21:3]
  call void @llvm.dbg.value(metadata !{i32* %i}, i64 0, metadata !906), !dbg !907 ; [debug line = 21:3] [debug variable = i]
  %i.load.2 = load volatile i32* %i, align 4, !dbg !907 ; [#uses=1 type=i32] [debug line = 21:3]
  %tmp.3 = sext i32 %i.load.2 to i64, !dbg !907   ; [#uses=1 type=i64] [debug line = 21:3]
  %inPtr.addr.1 = getelementptr inbounds i32* %inPtr, i64 %tmp.3, !dbg !907 ; [#uses=1 type=i32*] [debug line = 21:3]
  store volatile i32 %tmp.2, i32* %inPtr.addr.1, align 4, !dbg !907 ; [debug line = 21:3]
  call void @llvm.dbg.value(metadata !{i32* %i}, i64 0, metadata !906), !dbg !909 ; [debug line = 20:18] [debug variable = i]
  %i.load.3 = load volatile i32* %i, align 4, !dbg !909 ; [#uses=1 type=i32] [debug line = 20:18]
  %i.1 = add nsw i32 %i.load.3, 1, !dbg !909      ; [#uses=1 type=i32] [debug line = 20:18]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !906), !dbg !909 ; [debug line = 20:18] [debug variable = i]
  store volatile i32 %i.1, i32* %i, align 4, !dbg !909 ; [debug line = 20:18]
  br label %1, !dbg !909                          ; [debug line = 20:18]

; <label>:3                                       ; preds = %1
  ret void, !dbg !910                             ; [debug line = 24:1]
}
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"/home/raghu/work/projects/dma3/hls/simple_top/solution1/.autopilot/db/simple_top.pragma.2.cpp", metadata !"/home/raghu/work/projects/dma3", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !828, metadata !830, metadata !838} ; [ DW_TAG_compile_unit ]
...
!832 = metadata !{i32 786478, i32 0, metadata !833, metadata !"simple_top", metadata !"simple_top", metadata !"_Z10simple_topPVi", metadata !833, i32 5, metadata !834, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32*)* @simple_top, null, null, metadata !84, i32 6} ; [ DW_TAG_subprogram ]
!833 = metadata !{i32 786473, metadata !"simple_top/simple_top.cpp", metadata !"/home/raghu/work/projects/dma3", null} ; [ DW_TAG_file_type ]
...
!839 = metadata !{metadata !840, metadata !842, metadata !843, metadata !844, metadata !845, metadata !846, metadata !847, metadata !848, metadata !849, metadata !850, metadata !851, metadata !852, metadata !853, metadata !854, metadata !855, metadata !856, metadata !857, metadata !858, metadata !859, metadata !861, metadata !862, metadata !863, metadata !864, metadata !867, metadata !868, metadata !869, metadata !870, metadata !871, metadata !872, metadata !875, metadata !876, metadata !877, metadata !879, metadata !880, metadata !881, metadata !882, metadata !883, metadata !884, metadata !885, metadata !886, metadata !888}
!840 = metadata !{i32 786484, i32 0, metadata !49, metadata !"boolalpha", metadata !"boolalpha", metadata !"boolalpha", metadata !5, i32 259, metadata !841, i32 1, i32 1, i17 1} ; [ DW_TAG_variable ]
!841 = metadata !{i32 786470, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !67} ; [ DW_TAG_const_type ]
!842 = metadata !{i32 786484, i32 0, metadata !49, metadata !"dec", metadata !"dec", metadata !"dec", metadata !5, i32 262, metadata !841, i32 1, i32 1, i17 2} ; [ DW_TAG_variable ]
!843 = metadata !{i32 786484, i32 0, metadata !49, metadata !"fixed", metadata !"fixed", metadata !"fixed", metadata !5, i32 265, metadata !841, i32 1, i32 1, i17 4} ; [ DW_TAG_variable ]
!844 = metadata !{i32 786484, i32 0, metadata !49, metadata !"hex", metadata !"hex", metadata !"hex", metadata !5, i32 268, metadata !841, i32 1, i32 1, i17 8} ; [ DW_TAG_variable ]
!845 = metadata !{i32 786484, i32 0, metadata !49, metadata !"internal", metadata !"internal", metadata !"internal", metadata !5, i32 273, metadata !841, i32 1, i32 1, i17 16} ; [ DW_TAG_variable ]
!846 = metadata !{i32 786484, i32 0, metadata !49, metadata !"left", metadata !"left", metadata !"left", metadata !5, i32 277, metadata !841, i32 1, i32 1, i17 32} ; [ DW_TAG_variable ]
!847 = metadata !{i32 786484, i32 0, metadata !49, metadata !"oct", metadata !"oct", metadata !"oct", metadata !5, i32 280, metadata !841, i32 1, i32 1, i17 64} ; [ DW_TAG_variable ]
!848 = metadata !{i32 786484, i32 0, metadata !49, metadata !"right", metadata !"right", metadata !"right", metadata !5, i32 284, metadata !841, i32 1, i32 1, i17 128} ; [ DW_TAG_variable ]
!849 = metadata !{i32 786484, i32 0, metadata !49, metadata !"scientific", metadata !"scientific", metadata !"scientific", metadata !5, i32 287, metadata !841, i32 1, i32 1, i17 256} ; [ DW_TAG_variable ]
!850 = metadata !{i32 786484, i32 0, metadata !49, metadata !"showbase", metadata !"showbase", metadata !"showbase", metadata !5, i32 291, metadata !841, i32 1, i32 1, i17 512} ; [ DW_TAG_variable ]
!851 = metadata !{i32 786484, i32 0, metadata !49, metadata !"showpoint", metadata !"showpoint", metadata !"showpoint", metadata !5, i32 295, metadata !841, i32 1, i32 1, i17 1024} ; [ DW_TAG_variable ]
!852 = metadata !{i32 786484, i32 0, metadata !49, metadata !"showpos", metadata !"showpos", metadata !"showpos", metadata !5, i32 298, metadata !841, i32 1, i32 1, i17 2048} ; [ DW_TAG_variable ]
!853 = metadata !{i32 786484, i32 0, metadata !49, metadata !"skipws", metadata !"skipws", metadata !"skipws", metadata !5, i32 301, metadata !841, i32 1, i32 1, i17 4096} ; [ DW_TAG_variable ]
!854 = metadata !{i32 786484, i32 0, metadata !49, metadata !"unitbuf", metadata !"unitbuf", metadata !"unitbuf", metadata !5, i32 304, metadata !841, i32 1, i32 1, i17 8192} ; [ DW_TAG_variable ]
!855 = metadata !{i32 786484, i32 0, metadata !49, metadata !"uppercase", metadata !"uppercase", metadata !"uppercase", metadata !5, i32 308, metadata !841, i32 1, i32 1, i17 16384} ; [ DW_TAG_variable ]
!856 = metadata !{i32 786484, i32 0, metadata !49, metadata !"adjustfield", metadata !"adjustfield", metadata !"adjustfield", metadata !5, i32 311, metadata !841, i32 1, i32 1, i17 176} ; [ DW_TAG_variable ]
!857 = metadata !{i32 786484, i32 0, metadata !49, metadata !"basefield", metadata !"basefield", metadata !"basefield", metadata !5, i32 314, metadata !841, i32 1, i32 1, i17 74} ; [ DW_TAG_variable ]
!858 = metadata !{i32 786484, i32 0, metadata !49, metadata !"floatfield", metadata !"floatfield", metadata !"floatfield", metadata !5, i32 317, metadata !841, i32 1, i32 1, i17 260} ; [ DW_TAG_variable ]
!859 = metadata !{i32 786484, i32 0, metadata !49, metadata !"badbit", metadata !"badbit", metadata !"badbit", metadata !5, i32 335, metadata !860, i32 1, i32 1, i17 1} ; [ DW_TAG_variable ]
!860 = metadata !{i32 786470, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !69} ; [ DW_TAG_const_type ]
!861 = metadata !{i32 786484, i32 0, metadata !49, metadata !"eofbit", metadata !"eofbit", metadata !"eofbit", metadata !5, i32 338, metadata !860, i32 1, i32 1, i17 2} ; [ DW_TAG_variable ]
!862 = metadata !{i32 786484, i32 0, metadata !49, metadata !"failbit", metadata !"failbit", metadata !"failbit", metadata !5, i32 343, metadata !860, i32 1, i32 1, i17 4} ; [ DW_TAG_variable ]
!863 = metadata !{i32 786484, i32 0, metadata !49, metadata !"goodbit", metadata !"goodbit", metadata !"goodbit", metadata !5, i32 346, metadata !860, i32 1, i32 1, i17 0} ; [ DW_TAG_variable ]
!864 = metadata !{i32 786484, i32 0, metadata !49, metadata !"app", metadata !"app", metadata !"app", metadata !5, i32 365, metadata !865, i32 1, i32 1, i17 1} ; [ DW_TAG_variable ]
!865 = metadata !{i32 786470, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !866} ; [ DW_TAG_const_type ]
!866 = metadata !{i32 786454, metadata !49, metadata !"openmode", metadata !5, i32 362, i64 0, i64 0, i64 0, i32 0, metadata !33} ; [ DW_TAG_typedef ]
!867 = metadata !{i32 786484, i32 0, metadata !49, metadata !"ate", metadata !"ate", metadata !"ate", metadata !5, i32 368, metadata !865, i32 1, i32 1, i17 2} ; [ DW_TAG_variable ]
!868 = metadata !{i32 786484, i32 0, metadata !49, metadata !"binary", metadata !"binary", metadata !"binary", metadata !5, i32 373, metadata !865, i32 1, i32 1, i17 4} ; [ DW_TAG_variable ]
!869 = metadata !{i32 786484, i32 0, metadata !49, metadata !"in", metadata !"in", metadata !"in", metadata !5, i32 376, metadata !865, i32 1, i32 1, i17 8} ; [ DW_TAG_variable ]
!870 = metadata !{i32 786484, i32 0, metadata !49, metadata !"out", metadata !"out", metadata !"out", metadata !5, i32 379, metadata !865, i32 1, i32 1, i17 16} ; [ DW_TAG_variable ]
!871 = metadata !{i32 786484, i32 0, metadata !49, metadata !"trunc", metadata !"trunc", metadata !"trunc", metadata !5, i32 382, metadata !865, i32 1, i32 1, i17 32} ; [ DW_TAG_variable ]
!872 = metadata !{i32 786484, i32 0, metadata !49, metadata !"beg", metadata !"beg", metadata !"beg", metadata !5, i32 397, metadata !873, i32 1, i32 1, i17 0} ; [ DW_TAG_variable ]
!873 = metadata !{i32 786470, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !874} ; [ DW_TAG_const_type ]
!874 = metadata !{i32 786454, metadata !49, metadata !"seekdir", metadata !5, i32 394, i64 0, i64 0, i64 0, i32 0, metadata !42} ; [ DW_TAG_typedef ]
!875 = metadata !{i32 786484, i32 0, metadata !49, metadata !"cur", metadata !"cur", metadata !"cur", metadata !5, i32 400, metadata !873, i32 1, i32 1, i17 1} ; [ DW_TAG_variable ]
!876 = metadata !{i32 786484, i32 0, metadata !49, metadata !"end", metadata !"end", metadata !"end", metadata !5, i32 403, metadata !873, i32 1, i32 1, i17 2} ; [ DW_TAG_variable ]
!877 = metadata !{i32 786484, i32 0, metadata !94, metadata !"none", metadata !"none", metadata !"none", metadata !96, i32 99, metadata !878, i32 1, i32 1, i32 0} ; [ DW_TAG_variable ]
!878 = metadata !{i32 786470, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !224} ; [ DW_TAG_const_type ]
!879 = metadata !{i32 786484, i32 0, metadata !94, metadata !"ctype", metadata !"ctype", metadata !"ctype", metadata !96, i32 100, metadata !878, i32 1, i32 1, i32 1} ; [ DW_TAG_variable ]
!880 = metadata !{i32 786484, i32 0, metadata !94, metadata !"numeric", metadata !"numeric", metadata !"numeric", metadata !96, i32 101, metadata !878, i32 1, i32 1, i32 2} ; [ DW_TAG_variable ]
!881 = metadata !{i32 786484, i32 0, metadata !94, metadata !"collate", metadata !"collate", metadata !"collate", metadata !96, i32 102, metadata !878, i32 1, i32 1, i32 4} ; [ DW_TAG_variable ]
!882 = metadata !{i32 786484, i32 0, metadata !94, metadata !"time", metadata !"time", metadata !"time", metadata !96, i32 103, metadata !878, i32 1, i32 1, i32 8} ; [ DW_TAG_variable ]
!883 = metadata !{i32 786484, i32 0, metadata !94, metadata !"monetary", metadata !"monetary", metadata !"monetary", metadata !96, i32 104, metadata !878, i32 1, i32 1, i32 16} ; [ DW_TAG_variable ]
!884 = metadata !{i32 786484, i32 0, metadata !94, metadata !"messages", metadata !"messages", metadata !"messages", metadata !96, i32 105, metadata !878, i32 1, i32 1, i32 32} ; [ DW_TAG_variable ]
!885 = metadata !{i32 786484, i32 0, metadata !94, metadata !"all", metadata !"all", metadata !"all", metadata !96, i32 106, metadata !878, i32 1, i32 1, i32 63} ; [ DW_TAG_variable ]
!886 = metadata !{i32 786484, i32 0, metadata !289, metadata !"npos", metadata !"npos", metadata !"npos", metadata !120, i32 279, metadata !887, i32 1, i32 1, i64 -1} ; [ DW_TAG_variable ]
!887 = metadata !{i32 786470, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !391} ; [ DW_TAG_const_type ]
...
!890 = metadata !{i32 786473, metadata !"/home/raghu/work/tools/xilinx/Vivado_HLS/2013.3/lnx64/tools/gcc/lib/gcc/x86_64-unknown-linux-gnu/4.6.3/../../../../include/c++/4.6.3/iostream", metadata !"/home/raghu/work/projects/dma3", null} ; [ DW_TAG_file_type ]
!891 = metadata !{i32 786434, metadata !49, metadata !"Init", metadata !5, i32 534, i64 8, i64 8, i32 0, i32 0, null, metadata !892, i32 0, null, null} ; [ DW_TAG_class_type ]
!892 = metadata !{metadata !893, metadata !897, metadata !898}
!893 = metadata !{i32 786478, i32 0, metadata !891, metadata !"Init", metadata !"Init", metadata !"", metadata !5, i32 538, metadata !894, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !84, i32 538} ; [ DW_TAG_subprogram ]
...
!897 = metadata !{i32 786478, i32 0, metadata !891, metadata !"~Init", metadata !"~Init", metadata !"", metadata !5, i32 539, metadata !894, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !84, i32 539} ; [ DW_TAG_subprogram ]
!898 = metadata !{i32 786474, metadata !891, null, metadata !5, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !49} ; [ DW_TAG_friend ]
!899 = metadata !{i32 786689, metadata !832, metadata !"inPtr", metadata !833, i32 16777221, metadata !836, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!900 = metadata !{i32 5, i32 31, metadata !832, null}
!901 = metadata !{i32 7, i32 1, metadata !902, null}
!902 = metadata !{i32 786443, metadata !832, i32 6, i32 1, metadata !833, i32 0} ; [ DW_TAG_lexical_block ]
!903 = metadata !{i32 8, i32 1, metadata !902, null}
!904 = metadata !{i32 20, i32 7, metadata !905, null}
!905 = metadata !{i32 786443, metadata !902, i32 20, i32 2, metadata !833, i32 1} ; [ DW_TAG_lexical_block ]
!906 = metadata !{i32 786688, metadata !902, metadata !"i", metadata !833, i32 13, metadata !837, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!907 = metadata !{i32 21, i32 3, metadata !908, null}
!908 = metadata !{i32 786443, metadata !905, i32 20, i32 23, metadata !833, i32 2} ; [ DW_TAG_lexical_block ]
!909 = metadata !{i32 20, i32 18, metadata !905, null}
!910 = metadata !{i32 24, i32 1, metadata !902, null}
