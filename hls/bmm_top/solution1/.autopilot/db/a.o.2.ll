...
define void @bmm_top(i256* %b1, i256* %b2, i256* %b3, i32 %blockSize) {
  ...
  call void @llvm.dbg.value(metadata !{i256* %b2}, i64 0, metadata !933), !dbg !934 ; [debug line = 17:77] [debug variable = b2]
  call void @llvm.dbg.value(metadata !{i256* %b3}, i64 0, metadata !935), !dbg !936 ; [debug line = 17:124] [debug variable = b3]
  call void @llvm.dbg.value(metadata !{i32 %blockSize}, i64 0, metadata !937), !dbg !938 ; [debug line = 17:159] [debug variable = blockSize]
  call void @llvm.dbg.value(metadata !{i32 %blockSize}, i64 0, metadata !937), !dbg !938 ; [debug line = 17:159] [debug variable = blockSize]
  call void @llvm.dbg.value(metadata !{i32 %blockSize}, i64 0, metadata !937), !dbg !938 ; [debug line = 17:159] [debug variable = blockSize]
  call void @llvm.dbg.value(metadata !{i32 %blockSize}, i64 0, metadata !937), !dbg !938 ; [debug line = 17:159] [debug variable = blockSize]
  call void @llvm.dbg.value(metadata !{i32 %blockSize}, i64 0, metadata !937), !dbg !938 ; [debug line = 17:159] [debug variable = blockSize]
  ...
  %_shl = shl i32 %blockSize, 3, !dbg !949        ; [#uses=1 type=i32] [debug line = 36:2]
  %_shl9 = shl i32 %blockSize, 1, !dbg !949       ; [#uses=2 type=i32] [debug line = 36:2]
  %tmp = add i32 %_shl, %_shl9, !dbg !949         ; [#uses=1 type=i32] [debug line = 36:2]
  %tmp.1 = sext i32 %tmp to i256, !dbg !949       ; [#uses=1 type=i256] [debug line = 36:2]
  store volatile i256 %tmp.1, i256* %b1, align 32, !dbg !949 ; [debug line = 36:2]
  %_shl1 = shl i32 %blockSize, 4, !dbg !950       ; [#uses=1 type=i32] [debug line = 37:2]
  %_shl2 = shl i32 %blockSize, 2, !dbg !950       ; [#uses=1 type=i32] [debug line = 37:2]
  %tmp.2 = add i32 %_shl1, %_shl2, !dbg !950      ; [#uses=1 type=i32] [debug line = 37:2]
  %tmp.3 = sext i32 %tmp.2 to i256, !dbg !950     ; [#uses=1 type=i256] [debug line = 37:2]
  store volatile i256 %tmp.3, i256* %b2, align 32, !dbg !950 ; [debug line = 37:2]
  %_shl3 = shl i32 %blockSize, 5, !dbg !951       ; [#uses=1 type=i32] [debug line = 38:2]
  %tmp.4 = sub i32 %_shl3, %_shl9, !dbg !951      ; [#uses=1 type=i32] [debug line = 38:2]
  %tmp.5 = sext i32 %tmp.4 to i256, !dbg !951     ; [#uses=1 type=i256] [debug line = 38:2]
  store volatile i256 %tmp.5, i256* %b3, align 32, !dbg !951 ; [debug line = 38:2]
  call void @llvm.dbg.value(metadata !{i32 %blockSize}, i64 0, metadata !952), !dbg !953 ; [debug line = 40:23] [debug variable = bsize]
  %tmp.6 = mul nsw i32 %blockSize, %blockSize, !dbg !954 ; [#uses=1 type=i32] [debug line = 43:37]
  %total = lshr i32 %tmp.6, 3, !dbg !954          ; [#uses=1 type=i32] [debug line = 43:37]
  %total.cast = trunc i32 %total to i30, !dbg !954 ; [#uses=2 type=i30] [debug line = 43:37]
  call void @llvm.dbg.value(metadata !{i32 %total}, i64 0, metadata !955), !dbg !954 ; [debug line = 43:37] [debug variable = total]
  br label %1, !dbg !956                          ; [debug line = 44:7]

; <label>:1                                       ; preds = %branch896, %0
  %i = phi i29 [ 0, %0 ], [ %i.1, %branch896 ]    ; [#uses=3 type=i29]
  %i.cast = zext i29 %i to i30, !dbg !956         ; [#uses=1 type=i30] [debug line = 44:7]
  %tmp.7 = icmp ult i30 %i.cast, %total.cast, !dbg !956 ; [#uses=1 type=i1] [debug line = 44:7]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 0, i64 536870911, i64 0) ; [#uses=0 type=i32]
  br i1 %tmp.7, label %branch896, label %.preheader1, !dbg !956 ; [debug line = 44:7]

branch896:                                        ; preds = %1
  %tmp.8 = zext i29 %i to i64, !dbg !958          ; [#uses=3 type=i64] [debug line = 45:26]
  %b1.addr = getelementptr i256* %b1, i64 %tmp.8  ; [#uses=1 type=i256*]
  %curElemA = load volatile i256* %b1.addr, align 32, !dbg !958 ; [#uses=0 type=i256] [debug line = 45:26]
  call void @llvm.dbg.value(metadata !{i256 %curElemA}, i64 0, metadata !960), !dbg !958 ; [debug line = 45:26] [debug variable = curElemA]
  %b2.addr = getelementptr i256* %b2, i64 %tmp.8  ; [#uses=1 type=i256*]
  %curElemB = load volatile i256* %b2.addr, align 32, !dbg !961 ; [#uses=0 type=i256] [debug line = 46:26]
  call void @llvm.dbg.value(metadata !{i256 %curElemB}, i64 0, metadata !962), !dbg !961 ; [debug line = 46:26] [debug variable = curElemB]
  %b3.addr = getelementptr i256* %b3, i64 %tmp.8  ; [#uses=1 type=i256*]
  %curElemC = load volatile i256* %b3.addr, align 32, !dbg !963 ; [#uses=0 type=i256] [debug line = 47:26]
  call void @llvm.dbg.value(metadata !{i256 %curElemC}, i64 0, metadata !964), !dbg !963 ; [debug line = 47:26] [debug variable = curElemC]
  call void @llvm.dbg.value(metadata !{i256 %curElemA}, i64 0, metadata !965), !dbg !970 ; [debug line = 50:197] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i256 %curElemB}, i64 0, metadata !971), !dbg !973 ; [debug line = 51:200] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i256 %curElemC}, i64 0, metadata !974), !dbg !976 ; [debug line = 52:200] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i256 %curElemA}, i64 0, metadata !965), !dbg !970 ; [debug line = 50:197] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i256 %curElemB}, i64 0, metadata !971), !dbg !973 ; [debug line = 51:200] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i256 %curElemC}, i64 0, metadata !974), !dbg !976 ; [debug line = 52:200] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i256 %curElemA}, i64 0, metadata !965), !dbg !970 ; [debug line = 50:197] [debug variable = __Val2__]
  ...
  call void @llvm.dbg.value(metadata !{i256 %curElemB}, i64 0, metadata !971), !dbg !973 ; [debug line = 51:200] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i256 %curElemC}, i64 0, metadata !974), !dbg !976 ; [debug line = 52:200] [debug variable = __Val2__]
  %i.1 = add i29 %i, 1, !dbg !977                 ; [#uses=1 type=i29] [debug line = 44:23]
  br label %1, !dbg !977                          ; [debug line = 44:23]

.preheader1:                                      ; preds = %.preheader, %1
  %i5 = phi i29 [ %i.2, %.preheader ], [ 0, %1 ]  ; [#uses=3 type=i29]
  %i5.cast = zext i29 %i5 to i30, !dbg !978       ; [#uses=1 type=i30] [debug line = 62:14]
  %tmp. = icmp ult i30 %i5.cast, %total.cast, !dbg !978 ; [#uses=1 type=i1] [debug line = 62:14]
  %3 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 0, i64 536870911, i64 0) ; [#uses=0 type=i32]
  br i1 %tmp., label %.preheader, label %4, !dbg !978 ; [debug line = 62:14]

.preheader:                                       ; preds = %.preheader1
  %tmp.9 = zext i29 %i5 to i64, !dbg !980         ; [#uses=3 type=i64] [debug line = 72:3]
  %b1.addr.1 = getelementptr i256* %b1, i64 %tmp.9 ; [#uses=1 type=i256*]
  store volatile i256 0, i256* %b1.addr.1, align 32, !dbg !980 ; [debug line = 72:3]
  %b2.addr.1 = getelementptr i256* %b2, i64 %tmp.9 ; [#uses=1 type=i256*]
  store volatile i256 0, i256* %b2.addr.1, align 32, !dbg !982 ; [debug line = 73:3]
  %b3.addr.1 = getelementptr i256* %b3, i64 %tmp.9 ; [#uses=1 type=i256*]
  store volatile i256 0, i256* %b3.addr.1, align 32, !dbg !983 ; [debug line = 74:3]
  %i.2 = add i29 %i5, 1, !dbg !984                ; [#uses=1 type=i29] [debug line = 62:25]
  br label %.preheader1, !dbg !984                ; [debug line = 62:25]

; <label>:4                                       ; preds = %.preheader1
  ret void, !dbg !985                             ; [debug line = 158:1]
}
...
!913 = metadata !{i32 0, i32 2047, i32 1}
...
!931 = metadata !{i32 786465, i64 0, i64 2047}    ; [ DW_TAG_subrange_type ]
...
!938 = metadata !{i32 17, i32 159, metadata !832, null}
...
!949 = metadata !{i32 36, i32 2, metadata !940, null}
!950 = metadata !{i32 37, i32 2, metadata !940, null}
!951 = metadata !{i32 38, i32 2, metadata !940, null}
!952 = metadata !{i32 786688, metadata !940, metadata !"bsize", metadata !833, i32 40, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!953 = metadata !{i32 40, i32 23, metadata !940, null}
!954 = metadata !{i32 43, i32 37, metadata !940, null}
!955 = metadata !{i32 786688, metadata !940, metadata !"total", metadata !833, i32 43, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!956 = metadata !{i32 44, i32 7, metadata !957, null}
!957 = metadata !{i32 786443, metadata !940, i32 44, i32 2, metadata !833, i32 1} ; [ DW_TAG_lexical_block ]
!958 = metadata !{i32 45, i32 26, metadata !959, null}
!959 = metadata !{i32 786443, metadata !957, i32 44, i32 28, metadata !833, i32 2} ; [ DW_TAG_lexical_block ]
!960 = metadata !{i32 786688, metadata !959, metadata !"curElemA", metadata !833, i32 45, metadata !838, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!961 = metadata !{i32 46, i32 26, metadata !959, null}
!962 = metadata !{i32 786688, metadata !959, metadata !"curElemB", metadata !833, i32 46, metadata !838, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!963 = metadata !{i32 47, i32 26, metadata !959, null}
!964 = metadata !{i32 786688, metadata !959, metadata !"curElemC", metadata !833, i32 47, metadata !838, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!965 = metadata !{i32 786688, metadata !966, metadata !"__Val2__", metadata !833, i32 50, metadata !969, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!966 = metadata !{i32 786443, metadata !967, i32 50, i32 28, metadata !833, i32 5} ; [ DW_TAG_lexical_block ]
!967 = metadata !{i32 786443, metadata !968, i32 48, i32 40, metadata !833, i32 4} ; [ DW_TAG_lexical_block ]
!968 = metadata !{i32 786443, metadata !959, i32 48, i32 3, metadata !833, i32 3} ; [ DW_TAG_lexical_block ]
!969 = metadata !{i32 786468, null, metadata !"uint256", null, i32 0, i64 256, i64 256, i64 0, i32 0, i32 7} ; [ DW_TAG_base_type ]
!970 = metadata !{i32 50, i32 197, metadata !966, null}
!971 = metadata !{i32 786688, metadata !972, metadata !"__Val2__", metadata !833, i32 51, metadata !969, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!972 = metadata !{i32 786443, metadata !967, i32 51, i32 31, metadata !833, i32 6} ; [ DW_TAG_lexical_block ]
!973 = metadata !{i32 51, i32 200, metadata !972, null}
!974 = metadata !{i32 786688, metadata !975, metadata !"__Val2__", metadata !833, i32 52, metadata !969, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!975 = metadata !{i32 786443, metadata !967, i32 52, i32 31, metadata !833, i32 7} ; [ DW_TAG_lexical_block ]
!976 = metadata !{i32 52, i32 200, metadata !975, null}
!977 = metadata !{i32 44, i32 23, metadata !957, null}
!978 = metadata !{i32 62, i32 14, metadata !979, null}
!979 = metadata !{i32 786443, metadata !940, i32 62, i32 2, metadata !833, i32 10} ; [ DW_TAG_lexical_block ]
!980 = metadata !{i32 72, i32 3, metadata !981, null}
!981 = metadata !{i32 786443, metadata !979, i32 62, i32 30, metadata !833, i32 11} ; [ DW_TAG_lexical_block ]
!982 = metadata !{i32 73, i32 3, metadata !981, null}
!983 = metadata !{i32 74, i32 3, metadata !981, null}
!984 = metadata !{i32 62, i32 25, metadata !979, null}
!985 = metadata !{i32 158, i32 1, metadata !940, null}
