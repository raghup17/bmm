...
define void @bmm_top(i256* %b1, i256* %b2, i256* %b3, i32 %blockSize) {
  ...
  call void @llvm.dbg.value(metadata !{i256* %b2}, i64 0, metadata !933), !dbg !934 ; [debug line = 17:81] [debug variable = b2]
  call void @llvm.dbg.value(metadata !{i256* %b3}, i64 0, metadata !935), !dbg !936 ; [debug line = 17:132] [debug variable = b3]
  call void @llvm.dbg.value(metadata !{i32 %blockSize}, i64 0, metadata !937), !dbg !938 ; [debug line = 17:171] [debug variable = blockSize]
  call void @llvm.dbg.value(metadata !{i32 %blockSize}, i64 0, metadata !937), !dbg !938 ; [debug line = 17:171] [debug variable = blockSize]
  call void @llvm.dbg.value(metadata !{i32 %blockSize}, i64 0, metadata !937), !dbg !938 ; [debug line = 17:171] [debug variable = blockSize]
  call void @llvm.dbg.value(metadata !{i32 %blockSize}, i64 0, metadata !937), !dbg !938 ; [debug line = 17:171] [debug variable = blockSize]
  call void @llvm.dbg.value(metadata !{i32 %blockSize}, i64 0, metadata !937), !dbg !938 ; [debug line = 17:171] [debug variable = blockSize]
  ...
  call void @llvm.dbg.value(metadata !{i32 %blockSize}, i64 0, metadata !949), !dbg !950 ; [debug line = 36:23] [debug variable = bsize]
  %_signbit = lshr i32 %blockSize, 31, !dbg !951  ; [#uses=1 type=i32] [debug line = 37:37]
  %_cond = trunc i32 %_signbit to i1, !dbg !951   ; [#uses=1 type=i1] [debug line = 37:37]
  %_neg = sub i32 0, %blockSize, !dbg !951        ; [#uses=1 type=i32] [debug line = 37:37]
  %_lshr = lshr i32 %_neg, 8, !dbg !951           ; [#uses=1 type=i32] [debug line = 37:37]
  %_lshr.cast = trunc i32 %_lshr to i25, !dbg !951 ; [#uses=1 type=i25] [debug line = 37:37]
  %_neg.t = sub i25 0, %_lshr.cast, !dbg !951     ; [#uses=1 type=i25] [debug line = 37:37]
  %_lshr.f = lshr i32 %blockSize, 8, !dbg !951    ; [#uses=1 type=i32] [debug line = 37:37]
  %_lshr.f.cast = trunc i32 %_lshr.f to i25, !dbg !951 ; [#uses=1 type=i25] [debug line = 37:37]
  %tmp = select i1 %_cond, i25 %_neg.t, i25 %_lshr.f.cast, !dbg !951 ; [#uses=1 type=i25] [debug line = 37:37]
  %tmp.cast2 = zext i25 %tmp to i26, !dbg !951    ; [#uses=1 type=i26] [debug line = 37:37]
  %tmp.1 = shl nuw i26 %tmp.cast2, 1, !dbg !951   ; [#uses=1 type=i26] [debug line = 37:37]
  %dim = and i26 %tmp.1, -8, !dbg !951            ; [#uses=1 type=i26] [debug line = 37:37]
  %dim.cast = sext i26 %dim to i32, !dbg !951     ; [#uses=4 type=i32] [debug line = 37:37]
  call void @llvm.dbg.value(metadata !{i26 %dim}, i64 0, metadata !952), !dbg !951 ; [debug line = 37:37] [debug variable = dim]
  br label %1, !dbg !953                          ; [debug line = 38:7]

; <label>:1                                       ; preds = %2, %0
  %i = phi i32 [ 0, %0 ], [ %i.1, %2 ]            ; [#uses=4 type=i32]
  %tmp.3 = icmp slt i32 %i, %blockSize, !dbg !953 ; [#uses=1 type=i1] [debug line = 38:7]
  br i1 %tmp.3, label %.preheader5, label %3, !dbg !953 ; [debug line = 38:7]

.preheader5:                                      ; preds = %branch65920, %1
  %t1 = phi i32 [ %t1.1, %branch65920 ], [ 0, %1 ] ; [#uses=3 type=i32]
  %tmp.4 = icmp slt i32 %t1, %dim.cast, !dbg !955 ; [#uses=1 type=i1] [debug line = 42:16]
  br i1 %tmp.4, label %branch65920, label %.preheader4, !dbg !955 ; [debug line = 42:16]

branch65920:                                      ; preds = %.preheader5
  %tmp.5 = add nsw i32 %t1, %i, !dbg !958         ; [#uses=1 type=i32] [debug line = 43:30]
  %tmp.6 = sext i32 %tmp.5 to i64, !dbg !958      ; [#uses=2 type=i64] [debug line = 43:30]
  %b1.addr = getelementptr i256* %b1, i64 %tmp.6  ; [#uses=1 type=i256*]
  %curElemA = load volatile i256* %b1.addr, align 32, !dbg !958 ; [#uses=0 type=i256] [debug line = 43:30]
  call void @llvm.dbg.value(metadata !{i256 %curElemA}, i64 0, metadata !960), !dbg !958 ; [debug line = 43:30] [debug variable = curElemA]
  %b3.addr = getelementptr i256* %b3, i64 %tmp.6  ; [#uses=1 type=i256*]
  %curElemC = load volatile i256* %b3.addr, align 32, !dbg !961 ; [#uses=0 type=i256] [debug line = 44:30]
  call void @llvm.dbg.value(metadata !{i256 %curElemC}, i64 0, metadata !962), !dbg !961 ; [debug line = 44:30] [debug variable = curElemC]
  call void @llvm.dbg.value(metadata !{i256 %curElemA}, i64 0, metadata !963), !dbg !968 ; [debug line = 47:205] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i256 %curElemC}, i64 0, metadata !969), !dbg !971 ; [debug line = 48:208] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i256 %curElemA}, i64 0, metadata !963), !dbg !968 ; [debug line = 47:205] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i256 %curElemC}, i64 0, metadata !969), !dbg !971 ; [debug line = 48:208] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i256 %curElemA}, i64 0, metadata !963), !dbg !968 ; [debug line = 47:205] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i256 %curElemC}, i64 0, metadata !969), !dbg !971 ; [debug line = 48:208] [debug variable = __Val2__]
  ...
  call void @llvm.dbg.value(metadata !{i256 %curElemA}, i64 0, metadata !963), !dbg !968 ; [debug line = 47:205] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i256 %curElemC}, i64 0, metadata !969), !dbg !971 ; [debug line = 48:208] [debug variable = __Val2__]
  %t1.1 = add nsw i32 %t1, 1, !dbg !972           ; [#uses=1 type=i32] [debug line = 42:26]
  call void @llvm.dbg.value(metadata !{i32 %t1.1}, i64 0, metadata !973), !dbg !972 ; [debug line = 42:26] [debug variable = t1]
  br label %.preheader5, !dbg !972                ; [debug line = 42:26]

.preheader4:                                      ; preds = %.preheader2.0.preheader_ifconv, %.preheader5
  %j = phi i32 [ %j.1, %.preheader2.0.preheader_ifconv ], [ 0, %.preheader5 ] ; [#uses=3 type=i32]
  %tmp. = icmp slt i32 %j, %blockSize, !dbg !974  ; [#uses=1 type=i1] [debug line = 52:8]
  br i1 %tmp., label %.preheader3, label %.preheader1, !dbg !974 ; [debug line = 52:8]

.preheader3:                                      ; preds = %branch131968, %.preheader4
  %t = phi i32 [ %t1.2, %branch131968 ], [ 0, %.preheader4 ] ; [#uses=3 type=i32]
  %tmp.2 = icmp slt i32 %t, %dim.cast, !dbg !976  ; [#uses=1 type=i1] [debug line = 54:17]
  br i1 %tmp.2, label %branch131968, label %.preheader2.0.preheader_ifconv, !dbg !976 ; [debug line = 54:17]

.preheader2.0.preheader_ifconv:                   ; preds = %.preheader3
  %j.1 = add nsw i32 %j, 1, !dbg !979             ; [#uses=1 type=i32] [debug line = 52:22]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !980), !dbg !979 ; [debug line = 52:22] [debug variable = j]
  br label %.preheader4, !dbg !979                ; [debug line = 52:22]

branch131968:                                     ; preds = %.preheader3
  %tmp.8 = add nsw i32 %t, %j, !dbg !981          ; [#uses=1 type=i32] [debug line = 55:31]
  %tmp.9 = sext i32 %tmp.8 to i64, !dbg !981      ; [#uses=1 type=i64] [debug line = 55:31]
  %b2.addr = getelementptr i256* %b2, i64 %tmp.9  ; [#uses=1 type=i256*]
  %curElemB = load volatile i256* %b2.addr, align 32, !dbg !981 ; [#uses=0 type=i256] [debug line = 55:31]
  call void @llvm.dbg.value(metadata !{i256 %curElemB}, i64 0, metadata !983), !dbg !981 ; [debug line = 55:31] [debug variable = curElemB]
  call void @llvm.dbg.value(metadata !{i256 %curElemB}, i64 0, metadata !984), !dbg !988 ; [debug line = 58:205] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i256 %curElemB}, i64 0, metadata !984), !dbg !988 ; [debug line = 58:205] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i256 %curElemB}, i64 0, metadata !984), !dbg !988 ; [debug line = 58:205] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i256 %curElemB}, i64 0, metadata !984), !dbg !988 ; [debug line = 58:205] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i256 %curElemB}, i64 0, metadata !984), !dbg !988 ; [debug line = 58:205] [debug variable = __Val2__]
  ...
  call void @llvm.dbg.value(metadata !{i256 %curElemB}, i64 0, metadata !984), !dbg !988 ; [debug line = 58:205] [debug variable = __Val2__]
  call void @llvm.dbg.value(metadata !{i256 %curElemB}, i64 0, metadata !984), !dbg !988 ; [debug line = 58:205] [debug variable = __Val2__]
  %t1.2 = add nsw i32 %t, 1, !dbg !989            ; [#uses=1 type=i32] [debug line = 54:27]
  call void @llvm.dbg.value(metadata !{i32 %t1.2}, i64 0, metadata !990), !dbg !989 ; [debug line = 54:27] [debug variable = t1]
  br label %.preheader3, !dbg !989                ; [debug line = 54:27]

.preheader1:                                      ; preds = %.preheader.preheader_ifconv, %.preheader4
  %t3 = phi i32 [ %t1.3, %.preheader.preheader_ifconv ], [ 0, %.preheader4 ] ; [#uses=3 type=i32]
  %tmp.7 = icmp slt i32 %t3, %dim.cast, !dbg !991 ; [#uses=1 type=i1] [debug line = 72:16]
  br i1 %tmp.7, label %.preheader.preheader_ifconv, label %2, !dbg !991 ; [debug line = 72:16]

.preheader.preheader_ifconv:                      ; preds = %.preheader1
  %tmp.10 = add nsw i32 %t3, %i, !dbg !993        ; [#uses=1 type=i32] [debug line = 78:4]
  %tmp.11 = sext i32 %tmp.10 to i64, !dbg !993    ; [#uses=1 type=i64] [debug line = 78:4]
  %b3.addr.1 = getelementptr i256* %b3, i64 %tmp.11 ; [#uses=1 type=i256*]
  store volatile i256 0, i256* %b3.addr.1, align 32, !dbg !993 ; [debug line = 78:4]
  %t1.3 = add nsw i32 %t3, 1, !dbg !995           ; [#uses=1 type=i32] [debug line = 72:26]
  call void @llvm.dbg.value(metadata !{i32 %t1.3}, i64 0, metadata !996), !dbg !995 ; [debug line = 72:26] [debug variable = t1]
  br label %.preheader1, !dbg !995                ; [debug line = 72:26]

; <label>:2                                       ; preds = %.preheader1
  %i.1 = add nsw i32 %i, %dim.cast, !dbg !997     ; [#uses=1 type=i32] [debug line = 38:21]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !998), !dbg !997 ; [debug line = 38:21] [debug variable = i]
  br label %1, !dbg !997                          ; [debug line = 38:21]

; <label>:3                                       ; preds = %1
  ret void, !dbg !999                             ; [debug line = 113:1]
}
...
!938 = metadata !{i32 17, i32 171, metadata !832, null}
...
!949 = metadata !{i32 786688, metadata !940, metadata !"bsize", metadata !833, i32 36, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!950 = metadata !{i32 36, i32 23, metadata !940, null}
!951 = metadata !{i32 37, i32 37, metadata !940, null}
!952 = metadata !{i32 786688, metadata !940, metadata !"dim", metadata !833, i32 37, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!953 = metadata !{i32 38, i32 7, metadata !954, null}
!954 = metadata !{i32 786443, metadata !940, i32 38, i32 2, metadata !833, i32 1} ; [ DW_TAG_lexical_block ]
!955 = metadata !{i32 42, i32 16, metadata !956, null}
!956 = metadata !{i32 786443, metadata !957, i32 42, i32 3, metadata !833, i32 3} ; [ DW_TAG_lexical_block ]
!957 = metadata !{i32 786443, metadata !954, i32 38, i32 29, metadata !833, i32 2} ; [ DW_TAG_lexical_block ]
!958 = metadata !{i32 43, i32 30, metadata !959, null}
!959 = metadata !{i32 786443, metadata !956, i32 42, i32 32, metadata !833, i32 4} ; [ DW_TAG_lexical_block ]
!960 = metadata !{i32 786688, metadata !959, metadata !"curElemA", metadata !833, i32 43, metadata !838, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!961 = metadata !{i32 44, i32 30, metadata !959, null}
!962 = metadata !{i32 786688, metadata !959, metadata !"curElemC", metadata !833, i32 44, metadata !838, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!963 = metadata !{i32 786688, metadata !964, metadata !"__Val2__", metadata !833, i32 47, metadata !967, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!964 = metadata !{i32 786443, metadata !965, i32 47, i32 36, metadata !833, i32 7} ; [ DW_TAG_lexical_block ]
!965 = metadata !{i32 786443, metadata !966, i32 45, i32 47, metadata !833, i32 6} ; [ DW_TAG_lexical_block ]
!966 = metadata !{i32 786443, metadata !959, i32 45, i32 4, metadata !833, i32 5} ; [ DW_TAG_lexical_block ]
!967 = metadata !{i32 786468, null, metadata !"uint256", null, i32 0, i64 256, i64 256, i64 0, i32 0, i32 7} ; [ DW_TAG_base_type ]
!968 = metadata !{i32 47, i32 205, metadata !964, null}
!969 = metadata !{i32 786688, metadata !970, metadata !"__Val2__", metadata !833, i32 48, metadata !967, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!970 = metadata !{i32 786443, metadata !965, i32 48, i32 39, metadata !833, i32 8} ; [ DW_TAG_lexical_block ]
!971 = metadata !{i32 48, i32 208, metadata !970, null}
!972 = metadata !{i32 42, i32 26, metadata !956, null}
!973 = metadata !{i32 786688, metadata !956, metadata !"t1", metadata !833, i32 42, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!974 = metadata !{i32 52, i32 8, metadata !975, null}
!975 = metadata !{i32 786443, metadata !957, i32 52, i32 3, metadata !833, i32 9} ; [ DW_TAG_lexical_block ]
!976 = metadata !{i32 54, i32 17, metadata !977, null}
!977 = metadata !{i32 786443, metadata !978, i32 54, i32 4, metadata !833, i32 11} ; [ DW_TAG_lexical_block ]
!978 = metadata !{i32 786443, metadata !975, i32 52, i32 27, metadata !833, i32 10} ; [ DW_TAG_lexical_block ]
!979 = metadata !{i32 52, i32 22, metadata !975, null}
!980 = metadata !{i32 786688, metadata !940, metadata !"j", metadata !833, i32 30, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!981 = metadata !{i32 55, i32 31, metadata !982, null}
!982 = metadata !{i32 786443, metadata !977, i32 54, i32 33, metadata !833, i32 12} ; [ DW_TAG_lexical_block ]
!983 = metadata !{i32 786688, metadata !982, metadata !"curElemB", metadata !833, i32 55, metadata !838, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!984 = metadata !{i32 786688, metadata !985, metadata !"__Val2__", metadata !833, i32 58, metadata !967, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!985 = metadata !{i32 786443, metadata !986, i32 58, i32 36, metadata !833, i32 15} ; [ DW_TAG_lexical_block ]
!986 = metadata !{i32 786443, metadata !987, i32 56, i32 48, metadata !833, i32 14} ; [ DW_TAG_lexical_block ]
!987 = metadata !{i32 786443, metadata !982, i32 56, i32 5, metadata !833, i32 13} ; [ DW_TAG_lexical_block ]
!988 = metadata !{i32 58, i32 205, metadata !985, null}
!989 = metadata !{i32 54, i32 27, metadata !977, null}
!990 = metadata !{i32 786688, metadata !977, metadata !"t1", metadata !833, i32 54, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!991 = metadata !{i32 72, i32 16, metadata !992, null}
!992 = metadata !{i32 786443, metadata !957, i32 72, i32 3, metadata !833, i32 18} ; [ DW_TAG_lexical_block ]
!993 = metadata !{i32 78, i32 4, metadata !994, null}
!994 = metadata !{i32 786443, metadata !992, i32 72, i32 32, metadata !833, i32 19} ; [ DW_TAG_lexical_block ]
!995 = metadata !{i32 72, i32 26, metadata !992, null}
!996 = metadata !{i32 786688, metadata !992, metadata !"t1", metadata !833, i32 72, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!997 = metadata !{i32 38, i32 21, metadata !954, null}
!998 = metadata !{i32 786688, metadata !940, metadata !"i", metadata !833, i32 30, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!999 = metadata !{i32 113, i32 1, metadata !940, null}
