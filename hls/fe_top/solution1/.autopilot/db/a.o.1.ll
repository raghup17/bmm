; ModuleID = '/home/raghu/work/projects/dma3/hls/fe_top/solution1/.autopilot/db/a.g.1.bc'
...
@.str3 = private unnamed_addr constant [20 x i8] c"-bus_bundle CONTROL\00", align 1 ; [#uses=1 type=[20 x i8]*]
...
define void @fe_top(i32* %start, i32* %idle, i32* %done) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i32* %start}, i64 0, metadata !900), !dbg !901 ; [debug line = 2:36] [debug variable = start]
  call void @llvm.dbg.value(metadata !{i32* %idle}, i64 0, metadata !902), !dbg !903 ; [debug line = 2:65] [debug variable = idle]
  call void @llvm.dbg.value(metadata !{i32* %done}, i64 0, metadata !904), !dbg !905 ; [debug line = 2:93] [debug variable = done]
  call void (...)* @_ssdm_op_SpecWire(i32* %start, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !906 ; [debug line = 4:1]
  call void (...)* @_ssdm_op_SpecWire(i32* %idle, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !908 ; [debug line = 5:1]
  call void (...)* @_ssdm_op_SpecWire(i32* %done, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !909 ; [debug line = 6:1]
  call void (...)* @_ssdm_op_SpecResource(i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([20 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !910 ; [debug line = 7:1]
  store volatile i32 0, i32* %start, align 4, !dbg !911 ; [debug line = 8:2]
  br label %._crit_edge, !dbg !912                ; [debug line = 9:2]

._crit_edge:                                      ; preds = %._crit_edge, %0
  %idle.load = load volatile i32* %idle, align 4, !dbg !912 ; [#uses=1 type=i32] [debug line = 9:2]
  %tmp = icmp eq i32 %idle.load, 0, !dbg !912     ; [#uses=1 type=i1] [debug line = 9:2]
  br i1 %tmp, label %._crit_edge, label %1, !dbg !912 ; [debug line = 9:2]

; <label>:1                                       ; preds = %._crit_edge
  store volatile i32 -1, i32* %start, align 4, !dbg !913 ; [debug line = 10:2]
  store volatile i32 0, i32* %start, align 4, !dbg !914 ; [debug line = 11:2]
  br label %._crit_edge2, !dbg !915               ; [debug line = 12:2]

._crit_edge2:                                     ; preds = %._crit_edge1, %1
  %idle.load.1 = load volatile i32* %idle, align 4, !dbg !915 ; [#uses=1 type=i32] [debug line = 12:2]
  %tmp.1 = icmp eq i32 %idle.load.1, 0, !dbg !915 ; [#uses=1 type=i1] [debug line = 12:2]
  br i1 %tmp.1, label %2, label %._crit_edge1, !dbg !915 ; [debug line = 12:2]

; <label>:2                                       ; preds = %._crit_edge2
  %done.load = load volatile i32* %done, align 4, !dbg !915 ; [#uses=1 type=i32] [debug line = 12:2]
  %phitmp = icmp eq i32 %done.load, 0, !dbg !915  ; [#uses=1 type=i1] [debug line = 12:2]
  br label %._crit_edge1, !dbg !915               ; [debug line = 12:2]

._crit_edge1:                                     ; preds = %2, %._crit_edge2
  %tmp.2 = phi i1 [ %phitmp, %2 ], [ false, %._crit_edge2 ], !dbg !915 ; [#uses=1 type=i1] [debug line = 12:2]
  br i1 %tmp.2, label %._crit_edge2, label %3, !dbg !915 ; [debug line = 12:2]

; <label>:3                                       ; preds = %._crit_edge1
  store volatile i32 0, i32* %start, align 4, !dbg !916 ; [debug line = 13:2]
  ret void, !dbg !917                             ; [debug line = 14:1]
}
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"/home/raghu/work/projects/dma3/hls/fe_top/solution1/.autopilot/db/fe_top.pragma.2.cpp", metadata !"/home/raghu/work/projects/dma3", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !828, metadata !830, metadata !839} ; [ DW_TAG_compile_unit ]
...
!832 = metadata !{i32 786478, i32 0, metadata !833, metadata !"fe_top", metadata !"fe_top", metadata !"_Z6fe_topPVjS0_S0_", metadata !833, i32 2, metadata !834, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32*, i32*, i32*)* @fe_top, null, null, metadata !84, i32 3} ; [ DW_TAG_subprogram ]
!833 = metadata !{i32 786473, metadata !"fe_top/fe_top.cpp", metadata !"/home/raghu/work/projects/dma3", null} ; [ DW_TAG_file_type ]
...
!838 = metadata !{i32 786468, null, metadata !"unsigned int", null, i32 0, i64 32, i64 32, i64 0, i32 0, i32 7} ; [ DW_TAG_base_type ]
...
!891 = metadata !{i32 786473, metadata !"/home/raghu/work/tools/xilinx/Vivado_HLS/2013.3/lnx64/tools/gcc/lib/gcc/x86_64-unknown-linux-gnu/4.6.3/../../../../include/c++/4.6.3/iostream", metadata !"/home/raghu/work/projects/dma3", null} ; [ DW_TAG_file_type ]
...
!900 = metadata !{i32 786689, metadata !832, metadata !"start", metadata !833, i32 16777218, metadata !836, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!901 = metadata !{i32 2, i32 36, metadata !832, null}
!902 = metadata !{i32 786689, metadata !832, metadata !"idle", metadata !833, i32 33554434, metadata !836, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!903 = metadata !{i32 2, i32 65, metadata !832, null}
!904 = metadata !{i32 786689, metadata !832, metadata !"done", metadata !833, i32 50331650, metadata !836, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!905 = metadata !{i32 2, i32 93, metadata !832, null}
!906 = metadata !{i32 4, i32 1, metadata !907, null}
!907 = metadata !{i32 786443, metadata !832, i32 3, i32 1, metadata !833, i32 0} ; [ DW_TAG_lexical_block ]
!908 = metadata !{i32 5, i32 1, metadata !907, null}
!909 = metadata !{i32 6, i32 1, metadata !907, null}
!910 = metadata !{i32 7, i32 1, metadata !907, null}
!911 = metadata !{i32 8, i32 2, metadata !907, null}
!912 = metadata !{i32 9, i32 2, metadata !907, null}
!913 = metadata !{i32 10, i32 2, metadata !907, null}
!914 = metadata !{i32 11, i32 2, metadata !907, null}
!915 = metadata !{i32 12, i32 2, metadata !907, null}
!916 = metadata !{i32 13, i32 2, metadata !907, null}
!917 = metadata !{i32 14, i32 1, metadata !907, null}
