...
define void @fe_top(i32* %start, i32* %idle, i32* %done) nounwind uwtable {
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %start) nounwind, !map !907
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %idle) nounwind, !map !911
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %done) nounwind, !map !915
  call void (...)* @_ssdm_op_SpecTopModule([7 x i8]* @str) nounwind
  call void @llvm.dbg.value(metadata !{i32* %start}, i64 0, metadata !919), !dbg !920 ; [debug line = 2:36] [debug variable = start]
  call void @llvm.dbg.value(metadata !{i32* %idle}, i64 0, metadata !921), !dbg !922 ; [debug line = 2:65] [debug variable = idle]
  call void @llvm.dbg.value(metadata !{i32* %done}, i64 0, metadata !923), !dbg !924 ; [debug line = 2:93] [debug variable = done]
  call void (...)* @_ssdm_op_SpecWire(i32* %start, [8 x i8]* @.str, i32 0, i32 0, i32 0, [1 x i8]* @.str1) nounwind, !dbg !925 ; [debug line = 4:1]
  call void (...)* @_ssdm_op_SpecWire(i32* %idle, [8 x i8]* @.str, i32 0, i32 0, i32 0, [1 x i8]* @.str1) nounwind, !dbg !927 ; [debug line = 5:1]
  call void (...)* @_ssdm_op_SpecWire(i32* %done, [8 x i8]* @.str, i32 0, i32 0, i32 0, [1 x i8]* @.str1) nounwind, !dbg !928 ; [debug line = 6:1]
  call void (...)* @_ssdm_op_SpecIFCore(i32 0, [1 x i8]* @.str1, [10 x i8]* @.str2, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [20 x i8]* @.str3) nounwind, !dbg !929 ; [debug line = 7:1]
  store volatile i32 0, i32* %start, align 4, !dbg !930 ; [debug line = 8:2]
  br label %._crit_edge, !dbg !931                ; [debug line = 9:2]

._crit_edge:                                      ; preds = %._crit_edge, %0
  %idle.load = load volatile i32* %idle, align 4, !dbg !931 ; [#uses=1 type=i32] [debug line = 9:2]
  %tmp = icmp eq i32 %idle.load, 0, !dbg !931     ; [#uses=1 type=i1] [debug line = 9:2]
  br i1 %tmp, label %._crit_edge, label %1, !dbg !931 ; [debug line = 9:2]

; <label>:1                                       ; preds = %._crit_edge
  store volatile i32 -1, i32* %start, align 4, !dbg !932 ; [debug line = 10:2]
  store volatile i32 0, i32* %start, align 4, !dbg !933 ; [debug line = 11:2]
  br label %._crit_edge2, !dbg !934               ; [debug line = 12:2]

._crit_edge2:                                     ; preds = %._crit_edge1, %1
  %idle.load.1 = load volatile i32* %idle, align 4, !dbg !934 ; [#uses=1 type=i32] [debug line = 12:2]
  %tmp.1 = icmp eq i32 %idle.load.1, 0, !dbg !934 ; [#uses=1 type=i1] [debug line = 12:2]
  br i1 %tmp.1, label %2, label %._crit_edge1, !dbg !934 ; [debug line = 12:2]

; <label>:2                                       ; preds = %._crit_edge2
  %done.load = load volatile i32* %done, align 4, !dbg !934 ; [#uses=1 type=i32] [debug line = 12:2]
  %phitmp = icmp eq i32 %done.load, 0, !dbg !934  ; [#uses=1 type=i1] [debug line = 12:2]
  br label %._crit_edge1, !dbg !934               ; [debug line = 12:2]

._crit_edge1:                                     ; preds = %2, %._crit_edge2
  %tmp.2 = phi i1 [ %phitmp, %2 ], [ false, %._crit_edge2 ], !dbg !934 ; [#uses=1 type=i1] [debug line = 12:2]
  br i1 %tmp.2, label %._crit_edge2, label %3, !dbg !934 ; [debug line = 12:2]

; <label>:3                                       ; preds = %._crit_edge1
  store volatile i32 0, i32* %start, align 4, !dbg !935 ; [debug line = 13:2]
  ret void, !dbg !936                             ; [debug line = 14:1]
}
...
!910 = metadata !{metadata !"start", metadata !905, metadata !"unsigned int"}
!911 = metadata !{metadata !912}
!912 = metadata !{i32 0, i32 31, metadata !913}
!913 = metadata !{metadata !914}
!914 = metadata !{metadata !"idle", metadata !905, metadata !"unsigned int"}
!915 = metadata !{metadata !916}
!916 = metadata !{i32 0, i32 31, metadata !917}
!917 = metadata !{metadata !918}
!918 = metadata !{metadata !"done", metadata !905, metadata !"unsigned int"}
!919 = metadata !{i32 786689, metadata !832, metadata !"start", metadata !833, i32 16777218, metadata !836, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!920 = metadata !{i32 2, i32 36, metadata !832, null}
!921 = metadata !{i32 786689, metadata !832, metadata !"idle", metadata !833, i32 33554434, metadata !836, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!922 = metadata !{i32 2, i32 65, metadata !832, null}
!923 = metadata !{i32 786689, metadata !832, metadata !"done", metadata !833, i32 50331650, metadata !836, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!924 = metadata !{i32 2, i32 93, metadata !832, null}
!925 = metadata !{i32 4, i32 1, metadata !926, null}
!926 = metadata !{i32 786443, metadata !832, i32 3, i32 1, metadata !833, i32 0} ; [ DW_TAG_lexical_block ]
!927 = metadata !{i32 5, i32 1, metadata !926, null}
!928 = metadata !{i32 6, i32 1, metadata !926, null}
!929 = metadata !{i32 7, i32 1, metadata !926, null}
!930 = metadata !{i32 8, i32 2, metadata !926, null}
!931 = metadata !{i32 9, i32 2, metadata !926, null}
!932 = metadata !{i32 10, i32 2, metadata !926, null}
!933 = metadata !{i32 11, i32 2, metadata !926, null}
!934 = metadata !{i32 12, i32 2, metadata !926, null}
!935 = metadata !{i32 13, i32 2, metadata !926, null}
!936 = metadata !{i32 14, i32 1, metadata !926, null}
