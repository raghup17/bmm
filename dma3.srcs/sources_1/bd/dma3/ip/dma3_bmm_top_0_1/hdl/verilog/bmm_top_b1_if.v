...
//------------------------Instantiation------------------
// bmm_top_b1_request_preprocessor
bmm_top_b1_request_preprocessor #(
...
module bmm_top_b1_request_preprocessor/*{{{*/
#(parameter
    C_USER_DATA_WIDTH = 8
)(
    // system signal
...
module bmm_top_b1_read_data_align/*{{{*/
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
