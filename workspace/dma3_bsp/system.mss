...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = bmm_top_top
 PARAMETER DRIVER_VER = 19.00.a
 PARAMETER HW_INSTANCE = bmm_top_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bmm_top_top
 PARAMETER DRIVER_VER = 19.00.a
 PARAMETER HW_INSTANCE = bmm_top_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bmm_top_top
 PARAMETER DRIVER_VER = 19.00.a
 PARAMETER HW_INSTANCE = bmm_top_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bmm_top_top
 PARAMETER DRIVER_VER = 19.00.a
 PARAMETER HW_INSTANCE = bmm_top_3
END
